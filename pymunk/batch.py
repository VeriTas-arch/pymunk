...
.. note::
    ...
    versions including major, minor and patch versions!
...
class Buffer(object):
    ...
    def set_float_buf(self, buffer: Any) -> None:
        ...
        buffer should be an array of floats, implementing the buffer/memoryview
    ...
    def set_int_buf(self, buffer: Any) -> None:
        ...
        buffer should be an array of ints, implementing the buffer/memoryview
        interface like a numpy array or array.array.
